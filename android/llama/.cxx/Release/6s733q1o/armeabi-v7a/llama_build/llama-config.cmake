set(LLAMA_VERSION      0.0.3979)
set(LLAMA_BUILD_COMMIT 66875035)
set(LLAMA_BUILD_NUMBER 3979)
...
set(_llama_link_deps "${ggml_LIBRARY}" "OpenMP::OpenMP_C;OpenMP::OpenMP_CXX;Threads::Threads;m;dl")
set(_llama_transient_defines "GGML_SCHED_MAX_COPIES=4;GGML_USE_OPENMP;GGML_USE_LLAMAFILE;_XOPEN_SOURCE=600;_GNU_SOURCE;GGML_SHARED;GGML_BUILD")
